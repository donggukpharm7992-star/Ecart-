...
IMAGE_OUTPUT_DIR = LABEL_DIR.parent / "public" / "ward-drug-images"
...
def extract_side_label_images() -> dict[str, str]:
    ...
    for worksheet in workbook.worksheets:
        for image in worksheet._images:
            ...
            public_path = f"/ward-drug-images/{file_name}"
            for name in names:
...
def fetch_health_image(korean_name: str, common_name: str) -> tuple[str, str]:
    try:
        ...
        return f"/ward-drug-images/{file_name}", f"https://health.kr/searchDrug/result_drug.asp?drug_cd={quote(drug_code)}"
    except Exception as error:
...
def main() -> None:
    ...
    for raw in worksheet.iter_rows(min_row=2, values_only=True):
        ...
        image_path = image_path.replace("/pharmacy-drug-images/", "/ward-drug-images/").replace("pharmacy-drug-images/", "ward-drug-images/")
